...
Route::post('/users/authenticate', [UserController::class, 'handleLogin'])->name('users.signin_submit')->middleware(NotLoggedIn::class);
Route::get('/user/sign-in', [UserController::class, 'signIn'])->name('users.signin')->middleware(NotLoggedIn::class);
...
// TODO: This shit also needs proper check and cleanup
Route::get('/reset-password', function () {
    return view('auth.password_reset_form');
})->middleware(NotLoggedIn::class)->name('reset.password');
